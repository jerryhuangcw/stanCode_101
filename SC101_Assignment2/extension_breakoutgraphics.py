...
class BreakoutGraphics:
    ...
    def __init__(self, ball_radius=BALL_RADIUS, paddle_width=PADDLE_WIDTH,
        ...
        # Create a score board label
        self.score_label = GLabel("BRICKS LEFT: ")
        self.score_label.font = "arial-12"
        self.window.add(self.score_label, 3, self.window.height - 10)

        # Create a live board label
        self.live_label = GLabel("LIVES LEFT: ")
        self.live_label.font = "arial-12"
        self.window.add(self.live_label, window_width - 115, self.window.height - 10)
